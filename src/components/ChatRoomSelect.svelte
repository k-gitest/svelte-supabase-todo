...
<div class="w-full justify-center">
  {#each rooms as room}
    <button on:click={() => handleRoomChange(room.room_id)} class="block w-full h-10 border text-left cursor-pointer flex justify-between items-center px-1 rounded-md mb-1">
